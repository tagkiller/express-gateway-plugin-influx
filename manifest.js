      ...
      policy: (actionParams) => {
        ...
        return (req, res, next) => {
          ...
          function writePoint() {
            ...
            }]).then(() => logger.info(`metrics sent to ${actionParams.influxdbSchema.host}:${actionParams.influxdbSchema.port}/${actionParams.influxdbSchema.database} - application : ${actionParams.application}`))
            .catch(logger.error);
          };
